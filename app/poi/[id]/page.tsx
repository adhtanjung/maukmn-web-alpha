...
import { usePOIDetail } from "@/app/hooks/usePOIDetail";
...
export default function POIDetailPage() {
	...
	const { poi, loading, error, refetch } = usePOIDetail(poiId);
	...
	if (error || !poi) {
		return (
			<POIDetailError
				message={error || "This place could not be found."}
				onRetry={refetch}
			/>
		);
	}
